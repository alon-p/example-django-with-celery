"""
Django settings for example_django_with_celery project.
...
class Base(Configuration):
    ...
    SECRET_KEY = values.Value('XrqMbrGHsnqNSJCpRSyAqgqPWrfcgGliommVbdAVLwvfMvzdVP')
    ...
    ROOT_URLCONF = "example_django_with_celery.urls"
    ...
    WSGI_APPLICATION = "example_django_with_celery.wsgi.application"
